                ...
                <div className="text-center">
                  ...
                  <div className="mt-8 space-y-3 w-full max-w-sm">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-3 w-full px-6 py-4 bg-white text-slate-700 border border-slate-200 font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                    >
                      <Share2 size={20} />
                      <span>Share</span>
                    </button>
