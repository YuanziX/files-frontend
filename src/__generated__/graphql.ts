...
export type ConfirmUploadsMutation = { __typename?: 'Mutation', confirmUploads: Array<{ __typename?: 'File', id: string, filename: string, mimeType: string, size: number, uploadDate: any }> };
